...
nnoremap   :
vnoremap ,n :s/^\s*\zs/\=(line('.') - line("'<")+1).'. ' 
nmap ,b :call BulletList() 
nnoremap ,u v~
map ,tk tK
map ,th tH
nmap ,mj :tabe /home/donagh/DONAGHS/personal/journal/$(date +%Y)/$(date +%m)/$(date +%d)-$(date +%m).md
map ,tt :terminal zsh
nmap ,e g0jI<BS> jg0
nnoremap ,d :put=expand('%:p')
nmap ,/ <Plug>(easymotion-overwin-w) 
vmap ,/ <Plug>(easymotion-bd-w) 
omap ,/ <Plug>(easymotion-bd-w) 
map ,,w <Plug>(easymotion-prefix)
nnoremap ,r :so $MYVIMRC
noremap ,vv :tabe $MYVIMRC
nnoremap ,ws 60<
nnoremap ,hf :below wincmd f
nnoremap ,vf :vertical wincmd f
map ,f :Ranger
nnoremap ,y "+y
...
nnoremap j gj
nnoremap k gk
nmap mj :call Myjournal()
nmap mm 0i@dm -<Left><Right><Right>
nmap wj :call WorkJournal()
...
cmap  <Up>
cmap  <Right>
inoremap ,d =expand("%:p:h")
inoremap ,dp =getcwd()
inoremap ,s :w
cmap bx :call Scratch() 
cmap bk :wq
cnoremap bn :bn 
cmap s  :w
cmap ww :wq
cmap w  :w
cmap xx :q!
abbr mys "Proactively engaged in making a better life for myself and/or others"
let &cpo=s:cpo_save
unlet s:cpo_save
set background=dark
...
set modelines=1
set path=.,/usr/include,,,~/REPOS/
set ruler
set runtimepath=~/.vim,~/.vim/pack/nightsense/start/stellarized,~/.vim/plugins/vim-commentary,~/.vim/plugins/vim-airline,~/.vim/plugins/gruvbox,~/.vim/plugins/ranger.vim,~/.vim/plugins/vim-easymotion,~/.vim/plugins/goyo.vim,~/.vim/plugins/limelight.vim,~/.vim/plugins/vim-peekaboo,~/.vim/plugins/vim-markdown,~/.vim/plugins/vim-latex,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,~/.vim/plugins/vim-markdown/after,~/.vim/after
set shiftwidth=4
set showtabline=2
set smartcase
set smarttab
...
silent only
silent tabonly
cd ~/PORTABLE_ENV/vim/dotvim
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ~/zArchive/scratch.md
argglobal
%argdel
$argadd ~/zArchive/scratch.md
edit ~/zArchive/scratch.md
argglobal
let s:cpo_save=&cpo
set cpo&vim
