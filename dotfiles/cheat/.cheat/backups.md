...
# Laptop            :: ~/BACKUPS/CLONE_ALL_SD64     ::: All of DONAGHS + all of REPOSITORIES (17GB                  <-- MASSIVE)  :::: untar .tar.gz files
# Raspberry Pi      :: USB_128                      ::: /srv/dev-disk-by-label-MyUSB/USB128_2/SAFE_borg_backup      <-- borg      :::: borg restore
#
# Note re borg: For a backup would need to create a temp folder to borg restore to.
#
}}}
