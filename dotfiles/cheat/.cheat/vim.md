...
# Reformat / justify paragraph etc.

V= - select text, then reformat with = = - will correct alignment of code == - one line; gq - reformat paragraph
...
(You can undo it with `u` or several J commands in normal mode — i.e. uppercase j)
