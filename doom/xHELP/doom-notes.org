...
* DOOM EMACS
** abbrevs
[[text expansion]] below for how to make new abbreviations / text expansion
...
Set: point-to-register [and give it a letter for reference] C-x r SPC
Go to: jump-to-register C-x r j
...
\gt gt
\lt lt
\mdash mdash or lh  (the last by dm)
